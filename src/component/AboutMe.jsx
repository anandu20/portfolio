...
const AboutMe = () => {
  ...
  return (
    <section
      id="about"
      className={`py-20  bp-8 bg-gradient-to-r from-[#91736B] to- [#f14a86]  text- ${fadeIn ? 'fade-in' : ''}`}
    >
      <div className="max-w-7xl mx-auto mb-8 flex flex-col md:flex-row items-center justify-center md:justify-between gap-10 sm:gap-16">
        ...
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="flex justify-center space-x-6 mt-4 "> {/* Added margin for spacing */}
        ...
        <div className="flex-1 max-w-xl text-content">
          <h2 className="text-4xl font-bold text-white mb-4">
            I'm <span className='text-red-500'>Anandu Ramachandran</span> 
          </h2>
      ...
      {/* Contact Information - Centered Below the Image */}
